...
function showBio(tile, value){
	...
	setTimeout(function(){
		...
		document.querySelector('.bio').textContent = tile.querySelector('.back').getAttribute('data-bio');
		document.querySelector('.learn_more').setAttribute('href', tile.querySelector('.back').getAttribute('data-link'))
	}, 500);
...
function flipCard(tile, value) {
	...
	var image = tile.querySelector('.back').getAttribute('data-img')
	var front = tile.querySelector('.front')
	var back = tile.querySelector('.back')
	var text_elem = document.createElement('span');
	text_elem.textContent = value;
	back.style.backgroundImage = "url('"+ image+"')";
	tile.classList.add('flipped');
	back.appendChild(text_elem);
...
function flipCardBack(tile, value) {
  ...
  var cardFrontImage = tile_1.querySelector('.front').getAttribute('data-cardFront')  

  tile_1.querySelector('.back').style.backgroundImage = "none";
  tile_1.querySelector('span').remove();
  tile_2.querySelector('.back').style.backgroundImage = "none";
  tile_2.querySelector('span').remove();
